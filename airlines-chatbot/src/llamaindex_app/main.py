...
def process_interaction(
    ...
    with tracer.start_as_current_span(
        ...
        try:
            ...
            if category == QueryCategory.AMERICAN_AIRLINES and response.source_nodes:
                interaction_span.set_attribute(
...
def handle_session(query_engine: any, classifier: QueryClassifier, tracer: any) -> bool:
    ...
    print(
        "\nWelcome! I'm here to help with questions about American Airlines' sustainability reports."
    )
    print("\nAvailable commands:")
