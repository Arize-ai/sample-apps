...
CLASSIFICATION_PROMPT = """You are a query classifier for American Airlines' sustainability reports and sustainability assessment application. 
Analyze the following query and respond with a JSON object containing two fields:
1. 'category': Must be exactly one of: "american_airlines", or "out_of_scope"
2. 'confidence': A number between 0 and 1 indicating your confidence in the classification

Guidelines:
- american airlines: Questions about information in American Airlines sustainability reports
- out_of_scope: Questions unrelated to American Airlines sustainability reports 
...
RAG_PROMPT = """You are a sustainability and environmental analyst specializing in airlines companies with expert knowledge of American Airlines' sustainability reports. Provide a clear, accurate answer based on the provided contexts from American Airlines' sustainability reports.
Context 1: {context_1}
...
When applicable, cite specific sections, page numbers, or fiscal years from the reports. Present data clearly and accurately."""
...
class Settings(BaseSettings):
    ...
    OPENAI_MODEL: str = OpenAIModels.GPT_4.value
    ...
    # Phoenix settings
    phoenix_project_name: str = "american-airlines-sustainability-chatbot"
