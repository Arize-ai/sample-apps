...
def _fmp_request(
    endpoint: str, params: Dict[str, Any] = None, max_retries: int = 3
) -> Dict[str, Any]:
    ...
    try:
        ...
        print(
            f"No FMP_API_KEY found. You can get an API key at https://site.financialmodelingprep.com/: {e}"
        )
    ...
    for attempt in range(max_retries):
        try:
            ...
            if e.code == 403:
                print(
                    "HTTP Error 403: API access forbidden. Please check your API key."
                )
...
def get_financial_ratios(
    symbol: str, period: Literal["annual", "quarter"] = "annual"
) -> List[dict]:
