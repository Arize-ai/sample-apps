...
def process_interaction(
    ...
    with tracer.start_as_current_span(
        ...
        try:
            ...
            if category == QueryCategory.BROADCOM_ETHERNET_NETWORK_ADAPTER_USER_GUIDE and response.source_nodes:
                interaction_span.set_attribute(
...
def handle_session(query_engine: any, classifier: QueryClassifier, tracer: any) -> bool:
    ...
    print(
        "\nWelcome! I'm here to help with questions about Broadcom's Ethernet Network Adapter User Guide."
    )
    print("\nAvailable commands:")
...
def main():
    try:
        ...
        print("\nWelcome to the Broadcom Ethernet Network Adapter User Guide!")
